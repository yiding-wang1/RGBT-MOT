...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='E:/lasher/LasHeR_Unalined_960_0615/seleted/2ndboyfarintheforest2right/visible/',
    ...
    parser.add_argument('--visible-source', type=str,
                        default='E:/lasher/LasHeR_Unalined_960_0615/seleted/2ndboyfarintheforest2right/visible/',
                        help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--infrared-source', type=str,
                        default='E:/lasher/LasHeR_Unalined_960_0615/seleted/2ndboyfarintheforest2right/infrared/',
                        help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--det_result', type=str, default='det_label.csv')
    parser.add_argument('--inner_det', type=bool, default=True, help="use yolo detector or exist detect result")
