...
def run_tracker_in_thread(args, filename):
    """
    ...
    """
    yolo = YOLO(args.yolo_model if is_ultralytics_model(args.yolo_model)
        else 'yolov8n.pt',)
...
def on_predict_start(predictor, persist=False):
    ...
    for i in range(predictor.dataset.bs):
        tracker = create_tracker(
            ...
            track_id=predictor.custom_args.track_id,
            track_all=predictor.custom_args.track_all
        )
