...
def create_tracker(tracker_type, tracker_config=None, reid_weights=None, device=None, half=None, per_class=None, evolve_param_dict=None,track_id=0,track_all=False):
    """
    ...
    tracker_args['track_id'] = track_id
    tracker_args['track_all'] = track_all
