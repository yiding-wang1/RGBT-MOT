...
class Track:
    ...
    def __init__(
        ...
        self.share_modality_features = []
        if detection.share_feat is not None:
            detection.share_feat /= np.linalg.norm(detection.share_feat)
            self.share_modality_features.append(detection.share_feat)

        self._n_init = n_init
        self._max_age = max_age

        self.kf = KalmanFilterXYAH()
        self.match_mean, self.match_covariance = None, None  # 用于匹配模态间轨迹
    ...
    def update_feat(self, detection):
        """Perform Kalman filter measurement update step and update the feature
        cache.
        Parameters
        ----------
    ...
    def update_pos_and_state(self, detection):
        """Perform Kalman filter measurement update step and update the feature
        cache.
        Parameters
        ----------
