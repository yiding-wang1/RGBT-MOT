...
from boxmot.trackers.rgbt_botsort.basetrack import BaseTrack, TrackState
from boxmot.utils.matching import (embedding_distance, fuse_score,
                                   iou_distance, linear_assignment)
from boxmot.trackers.basetracker import BaseTracker
from boxmot.trackers.rgbt_botsort.botsort_utils import joint_stracks, sub_stracks, remove_duplicate_stracks
from boxmot.trackers.rgbt_botsort.botsort_track import STrack
...
class RGBT_BotSort(BaseTracker):
    """
    ...
    def __init__(
        ...
        self.output_path = "../output_tracks/botsort_Two_Iwo/data/" + os.path.basename(self.img_path)
        self.total_time = 0
    ...
    def _first_association(self, dets, dets_first, active_tracks, unconfirmed, img, detections, activated_stracks, refind_stracks, strack_pool):
        ...
        # Fix camera motion
        warp,_ = self.cmc.apply(img, dets)
    ...
    def _prepare_output(self, activated_stracks, refind_stracks, lost_stracks, removed_stracks):
        ...
        save_results(self.frame_count, self.output_path, outputs, self.modality,self.total_time)
